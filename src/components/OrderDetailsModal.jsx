            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm font-medium text-gray-900">{order.subInvoice}</span>
                  </div>
                  <div className="flex justify-between">
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-600">Receiver Contact:</span>
                    <span className="text-sm font-medium text-gray-900">+91 8765432109</span>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    {isEditMode && canEdit ? (
                      ...
                      <p className="text-sm font-medium text-gray-900 mt-1">{editableData.deliveryAddress}</p>
                    )}
                  </div>
                  <div className="flex justify-between">
                    ...
                    {isEditMode && canEdit ? (
                      ...
                      <span className="text-sm font-medium text-gray-900">{editableData.expectedDeliveryDate}</span>
                    )}
                  </div>
                  {editableData.status === 'intransport' && (
                    <>
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-sm font-medium text-gray-900">+91 9876543210</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-sm text-gray-600">Vehicle Number:</span>
                        <span className="text-sm font-medium text-gray-900">MH-01-AB-1234</span>
                      </div>
                    </>
                  )}
                </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm font-medium text-gray-900">TXN-789123</span>
                  </div>
                  <div className="flex justify-between">
