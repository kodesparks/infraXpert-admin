      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <CardTitle className="text-lg font-medium">Cement Orders</CardTitle>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <CardTitle className="text-lg font-medium">Steel Orders</CardTitle>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm text-gray-600">Cement order #INV-001234 delivered</span>
                <span className="text-xs text-gray-400 ml-auto">2 hours ago</span>
              </div>
              <Separator />
              <div className="flex items-center space-x-3">
                <Package className="w-4 h-4 text-blue-500" />
                <span className="text-sm text-gray-600">Steel order #INV-001235 confirmed</span>
                <span className="text-xs text-gray-400 ml-auto">4 hours ago</span>
              </div>
              <Separator />
              <div className="flex items-center space-x-3">
                <AlertCircle className="w-4 h-4 text-orange-500" />
                <span className="text-sm text-gray-600">New lead generated for cement supply</span>
